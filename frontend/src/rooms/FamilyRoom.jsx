  ...
  const features = [
    {
      ...
      description: 'Designed specifically for families with children'
    },
    {
      icon: '🛏️',
      title: 'Spacious Comfort',
      description: 'Ample space with multiple beds for everyone'
    },
    {
      icon: '🎮',
      title: 'Child Friendly',
      description: 'Safe environment with entertainment options'
    },
    {
      icon: '🍽️',
      title: 'Family Dining',
      description: 'Special family meals and dining arrangements'
    }
  ];

  const overlayCards = [
    { icon: 'fas fa-users', text: 'Family Friendly' },
    { icon: 'fas fa-child', text: 'Kids Play Area' },
    { icon: 'fas fa-home', text: 'Spacious Rooms' }
  ];
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-md-6">
                      <div className="meta-item">
                        ...
                        <span style={{ color: '#6B7280' }}>Family Room</span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            ...
            <img
              src={selectedImage}
              alt={`Family Room - Image ${currentImageIndex + 1}`}
              className="img-fluid"
              style={{ 
                maxHeight: '80vh',
                objectFit: 'contain',
