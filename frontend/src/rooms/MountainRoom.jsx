...
const MountainRoom = () => {
  ...
  const room = {
    ...
    slug: "mountain-view",
    title: "Mountain View ",
    name: "Mountain View Deluxe Room",
    description: "Experience breathtaking Himalayan views from your private balcony. Luxurious room with premium amenities and direct mountain vistas.",
    detailedDescription: "Our Mountain View Deluxe Rooms offer an unparalleled experience with floor-to-ceiling windows and a private balcony overlooking the majestic Himalayan peaks. Designed for ultimate comfort and relaxation, these rooms feature premium bedding, modern furnishings with traditional Sikkimese accents, and exclusive amenities for a memorable stay. Wake up to stunning sunrise views over Kanchenjunga range and enjoy your morning tea while watching the mountains come alive.",
    price: "4500",
    ...
    features: [
      ...
      "Work desk with charging ports",
      "Soundproof for complete privacy",
      "Sunrise viewing lounge chair"
    ],
    images: [
      "/assets/rooms/mountain1.webp",
      "/assets/rooms/mountain2.jpg",
      "/assets/rooms/mountain3.jpg",
      "/assets/rooms/mountain4.jpg"
    ],
    rating: 4.9,
    reviews: 126,
    available: true,
    facilities: ["Free Parking", "High-Speed Wi-Fi", "24/7 Room Service", "Mountain View Restaurant", "Spa Access"]
  };
  ...
  const features = [
    {
      ...
      description: 'Uninterrupted views of Himalayan peaks'
    },
    {
      icon: '🛌',
      title: 'Luxury Comfort',
      description: 'Premium bedding and furnishings'
    },
    {
      icon: '🌅',
      title: 'Sunrise Magic',
      description: 'Perfect sunrise viewing location'
    },
    {
      icon: '☕',
      title: 'Private Balcony',
      description: 'Your personal mountain observatory'
    }
  ];

  const overlayCards = [
    { icon: 'fas fa-mountain', text: 'Mountain View' },
    { icon: 'fas fa-star', text: 'Premium Luxury' },
    { icon: 'fas fa-sun', text: 'Sunrise Spot' }
  ];
  ...
  return (
    <motion.div
      className="room-detail-page mountain-room"
              ...
              <div className="room-info">
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-md-6">
                      <div className="meta-item">
                        ...
                        <span style={{ color: '#6B7280' }}>Mountain View Deluxe</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="section-divider mb-4">
                  <h3 className="h4 mb-3" style={{ color: '#1F2933' }}>
                    <i className="fas fa-check-circle me-2" style={{ color: '#1E6F5C' }}></i> Room Features
                  </h3>
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            ...
            <img
              src={selectedImage}
              alt={`Mountain View Deluxe - Image ${currentImageIndex + 1}`}
              className="img-fluid"
              style={{ 
                maxHeight: '80vh',
                objectFit: 'contain',
      ...
      <div className="sikkim-layout1 py-5">
        ...
        <div className="sikkim-header text-center mb-5">
          <motion.h2
            ...
            transition={{ duration: 0.6 }}
          >
            <i className="fas fa-mountain me-3" style={{ color: 'rgb(30 111 92)' }}></i> Experience Himalayan Majesty
          </motion.h2>
          <motion.p
            className="fs-5 mx-auto"
            style={{ maxWidth: '600px', color: '#5D6D7E' }}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.2 }}
          >
            Wake up to breathtaking views of the world's highest peaks from your private sanctuary
          </motion.p>
        </div>
        ...
        <div className="container">
          <div className="row g-4">
            ...
            <div className="col-lg-4">
              ...
              >
                <i className="fas fa-star me-2" style={{ color: 'rgb(30 111 92)' }}></i> Premium Features
              </motion.h3>
            ...
            <div className="col-lg-5">
              ...
              >
                <i className="fas fa-camera me-2" style={{ color: 'rgb(30 111 92)' }}></i> Himalayan Panorama
              </motion.h3>
              <div className="image-wrapper position-relative rounded overflow-hidden mb-4" style={{ 
                boxShadow: '0 20px 40px rgba(52, 152, 219, 0.2)'
              }}>
                <img
                ...
                <motion.div
                  ...
                  style={{
                    background: 'linear-gradient(135deg, rgb(30 111 92) 0%, rgb(30 111 92) 100%)',
                    color: '#ffffff',
                    boxShadow: '0 8px 20px rgba(52, 219, 183, 0.3)',
                    zIndex: 3
                  }}
                  animate={{ y: [0, -10, 0] }}
              ...
              >
                <div className="testimonial-content">
                  <i className="fas fa-quote-left fs-3 mb-3 d-block" style={{ color: '#3498db' }}></i>
                  <p className="text-dark fs-5 mb-3 fst-italic">
                    "The most spectacular sunrise I've ever witnessed, right from my balcony!"
                  </p>
                  <div className="guest-info d-flex justify-content-between align-items-center">
                    <span style={{ color: '#5D6D7E' }}>Priya Sharma</span>
                    <span className="fw-medium text-dark">From Delhi</span>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="col-lg-3">
              <motion.h3
                ...
                transition={{ delay: 0.1 }}
              >
                <i className="fas fa-info-circle me-2" style={{ color: 'rgb(30 111 92)' }}></i> Mountain Info
              </motion.h3>
              
              {/* Mountain Specials */}
              <motion.div
                className="mountain-special p-3 mb-4 rounded"
                style={{
                ...
                transition={{ delay: 0.2 }}
              >
                <h4 className="h5 text-dark mb-3">Exclusive Experiences</h4>
                <ul className="special-list list-unstyled mb-0">
                  <li className="py-2 d-flex align-items-center gap-3 border-bottom border-secondary border-opacity-25">
                    <i className="fas fa-binoculars" style={{ color: 'rgb(30 111 92)' }}></i>
                    <span className="text-dark">Private Mountain Viewing</span>
                  </li>
                  <li className="py-2 d-flex align-items-center gap-3 border-bottom border-secondary border-opacity-25">
                    <i className="fas fa-camera" style={{ color: 'rgb(30 111 92)' }}></i>
                    <span className="text-dark">Sunrise Photography Session</span>
                  </li>
                  <li className="py-2 d-flex align-items-center gap-3 border-bottom border-secondary border-opacity-25">
                    <i className="fas fa-mug-hot" style={{ color: 'rgb(30 111 92)' }}></i>
                    <span className="text-dark">Balcony Breakfast Service</span>
                  </li>
                  <li className="py-2 d-flex align-items-center gap-3">
                    <i className="fas fa-star" style={{ color: 'rgb(30 111 92)' }}></i>
                    <span className="text-dark">Stargazing Night Setup</span>
                  </li>
                </ul>
              </motion.div>
              ...
              >
                <div className="weather-icon fs-1" style={{ opacity: 0.9 }}>☀️</div>
                <div className="weather-info">
                  <span className="temp d-block fs-2 fw-bold">15°C</span>
                  <span className="location d-block">Mountain View</span>
                  <span className="desc d-block fs-6 fst-italic" style={{ opacity: 0.8 }}>
                    Clear skies perfect for viewing
                  </span>
                </div>
              </motion.div>
              ...
              >
                <h4 className="h5 fw-bold mb-2">Book Your View</h4>
                <p className="mb-3" style={{ opacity: 0.9 }}>
                  Reserve this premium mountain view room
                </p>
                <button 
