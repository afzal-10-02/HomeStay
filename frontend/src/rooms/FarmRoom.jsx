...
const FarmRoom = () => {
  ...
  const room = {
    ...
    title: "Farm Cottage",
    name: "Farm Cottage",
    description: "Experience authentic rural living in our charming farm cottage, surrounded by organic gardens and peaceful countryside views.",
    detailedDescription: "Our Farm Cottage offers a genuine countryside experience with traditional Sikkimese farming aesthetics. Built with local materials and featuring a thatched roof (where possible), this cottage connects you with nature while providing modern comforts. Enjoy fresh organic produce from our farm, morning birdsong, and the peaceful rhythm of rural life. The cottage features a private veranda overlooking vegetable gardens and fruit orchards.",
    price: "3200",
    ...
    features: [
      ...
      "Traditional thatched design",
      "Farm-to-table dining",
      "Veranda with seating",
      "Composting facilities"
    ],
    images: [
      "/assets/rooms/farm1.webp",
      "/assets/rooms/farm2.webp",
      "/assets/rooms/farm3.webp",
      "/assets/rooms/farm4.webp"
    ],
    rating: 4.6,
    reviews: 78,
    available: true,
    facilities: ["Organic Farm Tour", "Free Breakfast", "Farm Kitchen Access", "Gardening Tools", "Bicycle Rental"]
  };
  ...
  const features = [
    {
      icon: '🌾',
      title: 'Organic Farm',
      description: 'Fresh produce from our organic gardens'
    },
    {
      icon: '🏡',
      title: 'Rustic Charm',
      description: 'Traditional Sikkimese farm cottage'
    },
    {
      icon: '🍅',
      title: 'Farm to Table',
      description: 'Meals prepared with fresh ingredients'
    },
    {
      icon: '🪴',
      title: 'Gardening',
      description: 'Try your hand at organic farming'
    }
  ];

  const overlayCards = [
    { icon: 'fas fa-tractor', text: 'Farm Experience' },
  ...
  return (
    <motion.div
      className="room-detail-page farm-room"
    ...
    >
      ...
      >
        ...
        <div className="room-hero-content text-center text-white position-relative z-2 pt-6">
          ...
          <div className="price-container d-flex align-items-center justify-content-center gap-3 flex-wrap mb-4">
            ...
            <span 
              className="room-price display-4 fw-bolder text-white"
            >
          ...
          <motion.div className="row g-4" variants={itemVariants}>
            <div className="col-lg-7">
              <div className="room-info">
                ...
                <p className="room-full-description fs-5 mb-4" style={{ color: '#6B7280' }}>
                ...
                >
                  <div className="row g-3">
                    ...
                    <div className="col-md-6">
                      <div className="meta-item">
                        <i className="fas fa-tractor fs-4" style={{ color: '#1E6F5C' }}></i>
                        <strong className="me-2" style={{ color: '#1F2933' }}>Category:</strong> 
                        <span style={{ color: '#6B7280' }}>Farm Cottage</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="section-divider mb-4">
                  <h3 className="h4 mb-3" style={{ color: '#1F2933' }}>
                    <i className="fas fa-check-circle me-2" style={{ color: '#1E6F5C' }} ></i> Farm Features
                  </h3>
            ...
            <div className="col-lg-5">
              <div className="room-gallery">
                <h3 className="h4 mb-3" style={{ color: '#1F2933' }}>Farm Gallery</h3>
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            ...
            <img
              src={selectedImage}
              alt={`Farm Cottage - Image ${currentImageIndex + 1}`}
              className="img-fluid"
              style={{ 
                maxHeight: '80vh',
                objectFit: 'contain',
      ...
      {/* Features Grid */}
      <div className="farm-layout py-5">
        <div 
        ...
        {/* Main Heading */}
        <div className="farm-header text-center mb-5">
          <motion.h2
            ...
            transition={{ duration: 0.6 }}
          >
            <i className="fas fa-tractor me-3" style={{ color: 'rgb(30 111 92)' }}></i> Experience Rural Sikkim
          </motion.h2>
          <motion.p
            className="fs-5 mx-auto"
            style={{ maxWidth: '600px', color: '#6B7280' }}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.2 }}
          >
            Connect with nature through traditional farming, organic living, and peaceful countryside
          </motion.p>
        </div>
        ...
        <div className="container">
          <div className="row g-4">
            ...
            <div className="col-lg-4">
              ...
              >
                <i className="fas fa-seedling me-2" style={{ color: 'rgb(30 111 92)' }}></i> Farm Features
              </motion.h3>
                  ...
                  >
                    <div className="d-flex align-items-start gap-3">
                      <div 
                        ...
                        style={{
                          background: 'linear-gradient(135deg, rgb(139 139 154 / 63%), rgb(142 168 162 / 63%))',
                          width: '60px',
                          height: '60px',
                          fontSize: '1.8rem',
                          color: 'white'
            ...
            <div className="col-lg-5">
              ...
              >
                <i className="fas fa-camera me-2" style={{ color: 'rgb(30 111 92)' }}></i> Farm Views
              </motion.h3>
              <div className="image-wrapper position-relative rounded overflow-hidden mb-4" style={{ 
                ...
                <img
                  ...
                  alt="Farm landscape with gardens"
                ...
                <div className="card-stack position-absolute top-0 start-0 p-3">
                  {overlayCards.map((card, index) => (
                    <motion.div
                      ...
                      whileHover={{ x: 10 }}
                    >
                      <i className={`${card.icon}`} style={{ color: 'rgb(30 111 92)' }}></i>
                ...
                <motion.div
                  ...
                  style={{
                    background: 'rgb(30 111 92)',
                    color: '#ffffff',
                    boxShadow: '0 8px 20px rgba(19, 139, 79, 0.3)',
                    zIndex: 3
                  }}
                  animate={{ y: [0, -10, 0] }}
              ...
              >
                <div className="testimonial-content">
                  <i className="fas fa-quote-left fs-3 mb-3 d-block" style={{ color: 'rgb(30 111 92)' }}></i>
                  <p className="text-dark fs-5 mb-3 fst-italic">
                    "Waking up to the sounds of the farm and eating fresh organic food was incredibly rejuvenating!"
                  </p>
                  <div className="guest-info d-flex justify-content-between align-items-center">
                    <span style={{ color: '#5D6D7E' }}>Rajesh Kumar</span>
                    <span className="fw-medium text-dark">From Kolkata</span>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="col-lg-3">
              <motion.h3
                ...
                transition={{ delay: 0.1 }}
              >
                <i className="fas fa-info-circle me-2" style={{ color: 'rgb(30 111 92)' }}></i> Farm Activities
              </motion.h3>
              
              {/* Farm Activities */}
              <motion.div
                className="farm-activities p-3 mb-4 rounded"
                style={{
                ...
                transition={{ delay: 0.2 }}
              >
                <h4 className="h5 text-dark mb-3">Daily Farm Activities</h4>
                <ul className="activities-list list-unstyled mb-0">
                  <li className="py-2 d-flex align-items-center gap-3 border-bottom border-secondary border-opacity-25">
                    <i className="fas fa-carrot" style={{ color: 'rgb(30 111 92)' }}></i>
                    <span className="text-dark">Organic Vegetable Harvesting</span>
                  </li>
                  <li className="py-2 d-flex align-items-center gap-3 border-bottom border-secondary border-opacity-25">
                    <i className="fas fa-cheese" style={{ color: 'rgb(30 111 92)' }}></i>
                    <span className="text-dark">Cheese Making Workshop</span>
                  </li>
                  <li className="py-2 d-flex align-items-center gap-3 border-bottom border-secondary border-opacity-25">
                    <i className="fas fa-mortar-pestle" style={{ color: 'rgb(30 111 92)' }}></i>
                    <span className="text-dark">Traditional Cooking Class</span>
                  </li>
                  <li className="py-2 d-flex align-items-center gap-3">
                    <i className="fas fa-cow" style={{ color: 'rgb(30 111 92)' }}></i>
                    <span className="text-dark">Dairy Farm Visit</span>
                  </li>
                </ul>
              </motion.div>
              ...
              {/* Season Widget */}
              <motion.div
                className="season-widget p-3 mb-4 rounded d-flex align-items-center gap-3 text-white"
                style={{
                  background: 'rgb(30 111 92)'
                }}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                <div className="season-icon fs-1" style={{ opacity: 0.9 }}>🌱</div>
                <div className="season-info">
                  <span className="season d-block fs-2 fw-bold">Harvest</span>
                  <span className="crop d-block">Season</span>
              ...
              >
                <h4 className="h5 fw-bold mb-2">Book Farm Stay</h4>
                <p className="mb-3" style={{ opacity: 0.9 }}>
                  Experience authentic farm life in Sikkim
                </p>
                <button 
