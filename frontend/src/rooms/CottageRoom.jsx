...
const CottageRoom = () => {
  ...
  const room = {
    ...
    title: "Cottage Room",
    name: "Cottage Room",
    description: "Charming and rustic cottage-style rooms that offer a cozy, homely feel with traditional Himalayan architecture. Perfect for families and nature lovers.",
    detailedDescription: "Experience authentic Himalayan living in our charming Cottage Rooms. Built with traditional local materials and featuring rustic decor, these rooms offer a warm and inviting atmosphere. Each cottage includes a private sitting area, traditional fireplace, and handcrafted wooden furnishings that blend seamlessly with the natural surroundings. Perfect for families or groups seeking an authentic mountain retreat.",
    price: "6500",
    discountedPrice: "5500",
    discount: "₹1000 off",
    size: "350 sq ft",
    maxGuests: "3-4 Adults",
    capacity: "3-4 Adults",
    ...
    reviews: 89,
    available: true,
    facilities: ["Private Garden", "Bonfire Area", "Traditional Kitchenette", "Family Lounge", "Children's Play Area", "Pet Friendly"]
  };
  ...
  const features = [
    {
      icon: '🏡',
      title: 'Rustic Charm',
      description: 'Traditional Himalayan architecture with authentic decor'
    },
    {
      icon: '🔥',
      title: 'Cozy Atmosphere',
      description: 'Warm fireplace and homely interiors for a comfortable stay'
    },
    {
      icon: '🌿',
      title: 'Nature Immersion',
      description: 'Surrounded by gardens with stunning mountain views'
    },
    {
      icon: '👨‍👩‍👧‍👦',
      title: 'Family Friendly',
      description: 'Perfect for families with spacious layouts and amenities'
    }
  ];

  const overlayCards = [
    { icon: 'fas fa-home', text: 'Traditional Cottage' },
    { icon: 'fas fa-fire', text: 'Cozy Fireplace' },
    { icon: 'fas fa-tree', text: 'Garden Views' }
  ];
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-md-6">
                      <div className="meta-item">
                        ...
                        <span style={{ color: '#6B7280' }}>Cottage Room</span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            ...
            <img
              src={selectedImage}
              alt={`Cottage Room - Image ${currentImageIndex + 1}`}
              className="img-fluid"
              style={{
                maxHeight: '80vh',
                objectFit: 'contain',
          ...
          <div className="row g-4">
              ...
              >
                <div className="testimonial-content">
                  ...
                  <p className="text-dark fs-5 mb-3 fst-italic">
                    "Absolutely luxurious! The most memorable stay of my life!"
                  </p>
                  <div className="guest-info d-flex justify-content-between align-items-center">
                    <span style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Vikram Bhat</span>
                    <span className="fw-medium text-dark">From Mumbai</span>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="col-lg-3">
              ...
              <motion.div
                ...
                transition={{ delay: 0.2 }}
              >
                <h4 className="h5 text-white mb-3">Luxury Experiences</h4>
                <ul className="special-list list-unstyled mb-0">
                  <li className="py-2 d-flex align-items-center gap-3 border-bottom border-light border-opacity-25">
                    <i className="fas fa-crown" style={{ color: 'rgb(30 111 92 / 94%)' }}></i>
                    <span className="text-dark">VIP Mountain Retreats</span>
                  </li>
                  <li className="py-2 d-flex align-items-center gap-3 border-bottom border-light border-opacity-25">
                    <i className="fas fa-spa" style={{ color: 'rgb(30 111 92 / 94%)' }}></i>
                    <span className="text-dark">Premium Spa Treatments</span>
                  </li>
                  {/* <li className="py-2 d-flex align-items-center gap-3 border-bottom border-light border-opacity-25">
                    <i className="fas fa-champagne-glass" style={{ color: 'rgb(30 111 92 / 94%)' }}></i>
                    <span className="text-dark">Fine Wine Tasting</span>
                  </li> */}
                  <li className="py-2 d-flex align-items-center gap-3">
                    <i className="fas fa-heart" style={{ color: 'rgb(30 111 92 / 94%)' }}></i>
                    <span className="text-dark">Romantic Dinner Setup</span>
                  </li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <p className="mb-3" style={{ opacity: 0.9 }}>
                  Reserve your luxurious Deluxe Room today
                </p>
                <button
