...
const services = [
  { title: "Budget Room", path: "/room/budget" },
  { title: "Cottage Room", path: "/room/cottage" },
  { title: "Family Suite", path: "/room/family" },
  { title: "Deluxe Suite", path: "/room/deluxe" },
  { title: "Mountain View Room", path: "/room/mountain-view" },
  { title: "Honeymoon Suite", path: "/room/honeymoon" }
];
    ...
    <div className="homestay-service-wrapper">
      <div className="homestay-service-container">
        ...
        <div className="homestay-right">
          <h2 className="service-heading">Explore Our Rooms</h2>
